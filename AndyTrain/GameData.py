...
class GameData(object):
    def __init__(self):
        ...
        self.lin1N = 10 #hidden variables
        self.lin2N = 4
        self.maxTrainPadding = 50
        self.TMSlope = True

#python snake.py -train -slope -maxtrainsize:1 -dataSrc:MasterCombo4 -saveas:lolweights
#python snake.py -train -loadweights:10_slope_size8
#python snake.py -train -pause -saveas:atrain
# dont use underscores in filenames
    '''
